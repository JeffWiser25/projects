...
// Function: Add a small square to mark the detected shape and calculate its midpoint
// Input: `is_ring` (1 if the shape is a ring, 0 if solid), `xtp` (x-coordinate), `ytp` (y-coordinate)
// Calculates the total number of black pixels, finds the vertical and horizontal midpoint, and marks the center with a square.
